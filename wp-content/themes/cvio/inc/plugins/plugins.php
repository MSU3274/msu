...
function cvio_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'slug'		=> 'cvio-plugin',
			'source'	=> CVIO_EXTRA_PLUGINS_DIRECTORY . '/normal/cvio-plugin/230423/' . 'cvio-plugin.zip',
			'required'	=> true,
			'version'	=> '3.2.2',
		),
	...
	if ( class_exists( 'CvioPlugin' ) ) {
		$plugins[] = array(
			...
			'source'				=> CVIO_EXTRA_PLUGINS_DIRECTORY . '/normal/acf/290823/' . 'advanced-custom-fields-pro.zip',
			'required'				=> true,
			'version'				=> '6.2.0',
		);
	}
